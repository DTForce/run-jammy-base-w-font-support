...
2. Build the image `docker build . -t dtforce/run-jammy-base-ttfonts:0.1.120 -t dtforce/run-jammy-base-ttfonts:latest` (or your tag)
3. Push the image `docker push dtforce/run-jammy-base-ttfonts:0.1.120 && docker push dtforce/run-jammy-base-ttfonts:latest` (or your tag)
